...
function BackOfCard() {
  return (
    <div className="absolute w-full h-full flex justify-center items-center bg-white transition-all z-10 card-back text-gray-700">
    <div className="p-4 overflow-y-auto">
    <p className="text-sm overflow-y-auto">Hey, you. You're finally awake.
