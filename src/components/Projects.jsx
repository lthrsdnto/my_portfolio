  ...
  return (
    <div className="max-w-screen-lg mx-auto py-8 my-8 font-poppins">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 place-items-center p-4 mx-auto">
        <div className="bg-gray-400 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-indigo-900 border-2 dark:border-none md:w-full w-5/6">
          <img
            src={splashy}
            alt=""
          ...
          <div className="dark:text-white text-gray-700 w-4/5 mx-auto ">
            ...
            <p className="text-justify md:text-base text-sm whitespace-normal md:h-24 h-16 overflow-auto scrollbar px-2">
        ...
        <div className="bg-gray-400 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-indigo-900 border-2 dark:border-none md:w-full w-5/6">
          ...
          <div className=" dark:text-white text-gray-700 w-4/5 mx-auto ">
            ...
            <p className="text-justify md:text-base text-sm whitespace-normal md:h-24 h-16 overflow-auto scrollbar">
